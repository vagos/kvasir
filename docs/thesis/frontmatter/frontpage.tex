...
{\huge \documenttype} \bigskip \\
{\Large \thesisauthor~(\studentnumber)} \bigskip \\
\end{tabular}
}
...
\node[anchor=north west, 
     ...
     {\includegraphics[width=14.75mm,keepaspectratio]{figs/Logos/\dtulogocolour_\targetcolourmodel.pdf}}; 
\end{tikzpicture}
...
\node[anchor=south, % anchor is bottom of picture
     ...
     {\includegraphics[height=18.9cm,keepaspectratio]{figs/DTU_stock_photo.jpg}};
\end{tikzpicture}
