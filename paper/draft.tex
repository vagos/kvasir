...
Developers refactor legacy code,
adapt libraries to evolving APIs, translate modules across programming
languages, and harden components against emerging security threats.
Each transformation demands a careful balance between preserving intended
functionality and satisfying new goals such as modularity, performance, or
safety.
While these transformations are conceptually simple, they are often
brittle, time-consuming, and require deep expertise.
...
This paper present \sys, a system for scalable program regeneration.
\sys allows users
...
\begin{itemize}
 ...
 \item A property-aware transformation framework, combining logic-based reasoning, minimal extraction, and LLM-backed synthesis;
 % TODO: Implementation of sys?
\end{itemize}

By coupling logic-driven reasoning with modern synthesis tools, \sys enables a new class of transformation workflows---ones that are expressive, verifiable, and adaptable across software tasks.
...
\midrule
  ...
  npm utilities                                           & Utilities from npm             & 20 & \cite{regbench2025} \\
Python utilities                                        & Utilities from PyPi            & 20 & \cite{regbench2025} \\
